...
class _PlaceDetailInfoState extends State<PlaceDetailInfo> {
      ...
      builder: (context, child) {
        return Positioned(
          top: MediaQuery
              ...
              .size
              .height *
              widget.animation.containerShowAnimation.value,
          left: 0,
          right: 0,
          bottom: 0,
          child: child,
  ...
  Widget _buildDirectionButton() {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Opacity(
          opacity: widget.animation.timeShowAnimation.value,
          child: Transform.translate(offset: Offset(-24, -24), child: child),
        );
      },
    );
  }
  ...
  Widget _buildName() {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Opacity(
          opacity: widget.animation.detailShowAnimation.value,
          child: child,
        );
      },
      child: Padding(
